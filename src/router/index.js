...
const routes = [
	{
		...
		children: [
			...
			},
			{
				...
				meta: { auth: false },
				component: () => import(/* webpackChunkName: "TopicCreate" */ '../views/TopicCreate.vue')
			},
			{
				path: 'topic/:id',
				name: 'TopicDetail',
				...
				meta: { auth: false },
				component: () => import(/* webpackChunkName: "TopicDetail" */ '../views/TopicDetail.vue')
			},
			{
				path: 'my/messages',
				name: 'Message',
			...
			},
			{
				...
				name: 'MyHome',
				meta: { auth: false },
				component: () => import(/* webpackChunkName: "MyHome" */ '../views/MyHome.vue')
			},
			{
				path: 'user/info',
				name: 'Info',
